...
input showFailsafeSignalBubbles = yes;
...
plot DebugBigArrow = if (useKnownVisibleSignalArrows and realShortEntry) or (debugPaintBigArrow and lastVisibleBar) or (debugForceArrows and debugForcedShortArrow) then high + bigArrowOff else Double.NaN;
...
plot DebugBigUpArrow = if (useKnownVisibleSignalArrows and realLongEntry) or (debugForceArrows and debugForcedLongArrow) then low - bigArrowOff else Double.NaN;
