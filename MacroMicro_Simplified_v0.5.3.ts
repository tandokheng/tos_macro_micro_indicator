...
AddChartBubble(
    ...
    low - off * 1.4,
    (if fastFlipLongArrow then "FLIP L " else if longContinuationArrow then "CONT L " else "ENTRY L ") +
...
AddChartBubble(
    ...
    high + off * 1.4,
    (if fastFlipShortArrow then "FLIP S " else if shortContinuationArrow then "CONT S " else "ENTRY S ") +
