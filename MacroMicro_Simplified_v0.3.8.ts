...
def sameSideLongExpired = lastEntryDir[1] == 1 and barsSincePlottedEntry > activeResetSameSideAfterBars and !trendResetLong;
def sameSideShortExpired = lastEntryDir[1] == -1 and barsSincePlottedEntry > activeResetSameSideAfterBars and !trendResetShort;
