...
# Active build: v0.5.45 QUIET DOTS.
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.45 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.45 QUIET DOTS", Color.BLACK);
