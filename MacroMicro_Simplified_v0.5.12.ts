...
plot MarkerLongDotV0511 =
    if arrowMarkerLong then low - liveArrowOff else Double.NaN;
MarkerLongDotV0511.SetPaintingStrategy(PaintingStrategy.POINTS);
MarkerLongDotV0511.SetLineWeight(5);
MarkerLongDotV0511.SetDefaultColor(Color.MAGENTA);

plot MarkerShortDotV0511 =
    if arrowMarkerShort then high + liveArrowOff else Double.NaN;
MarkerShortDotV0511.SetPaintingStrategy(PaintingStrategy.POINTS);
MarkerShortDotV0511.SetLineWeight(5);
MarkerShortDotV0511.SetDefaultColor(Color.CYAN);

plot BuildProofDotV0512 =
    if lastVisibleBar then high + liveArrowOff else Double.NaN;
BuildProofDotV0512.SetPaintingStrategy(PaintingStrategy.POINTS);
BuildProofDotV0512.SetLineWeight(5);
BuildProofDotV0512.SetDefaultColor(Color.CYAN);
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.12 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.12 DIAG", Color.BLACK);
AddLabel(yes, "MARKER: " + (if arrowMarkerLong then "L" else if arrowMarkerShort then "S" else "NONE"), if arrowMarkerLong then Color.MAGENTA else if arrowMarkerShort then Color.CYAN else Color.GRAY);
...
AddLabel(
    ...
    "TRIGGER: " +
        (if longDangerEdge then "DANGER LONG"
         ...
         else if continuationAnchorLongArrow then "CONT LONG"
         else if continuationAnchorShortArrow then "CONT SHORT"
         else if longContinuationArrow then "CONT LONG"
         else if shortContinuationArrow then "CONT SHORT"
    ...
    else if continuationAnchorLongArrow then Color.GREEN
    else if continuationAnchorShortArrow then Color.RED
    else if longContinuationArrow then Color.GREEN
    else if shortContinuationArrow then Color.RED
