...
# Active build: v0.5.44 ARMED DOTS.
...
def setupArmLongInvalid = !longTradeOK or longScore < setupArmFailureScore or setupShortTriggered;
def setupArmShortInvalid = !shortTradeOK or shortScore < setupArmFailureScore or setupLongTriggered;
def setupArmState =
    CompoundValue(
        1,
        if setupArmState[1] > 0 and (setupLongTriggered or setupArmLongInvalid or setupArmState[1] >= setupArmMaxBars) then 0
        else if setupArmState[1] < 0 and (setupShortTriggered or setupArmShortInvalid or AbsValue(setupArmState[1]) >= setupArmMaxBars) then 0
        else if setupArmState[1] == 0 and setupComingLongRaw then 1
        else if setupArmState[1] == 0 and setupComingShortRaw then -1
        else if setupArmState[1] > 0 then setupArmState[1] + 1
        else if setupArmState[1] < 0 then setupArmState[1] - 1
        else 0,
        0
    );
def setupComingLongDot = setupArmState == 1;
def setupComingShortDot = setupArmState == -1;
...
plot ReviewLongArrowV0544 =
    if showReviewSignalArrows and visibleLongSignal then low - reviewArrowOff else Double.NaN;
plot ReviewShortArrowV0544 =
    if showReviewSignalArrows and visibleShortSignal then high + reviewArrowOff else Double.NaN;
ReviewLongArrowV0544.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ReviewShortArrowV0544.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ReviewLongArrowV0544.AssignValueColor(Color.MAGENTA);
ReviewShortArrowV0544.AssignValueColor(Color.CYAN);
ReviewLongArrowV0544.SetLineWeight(5);
ReviewShortArrowV0544.SetLineWeight(5);

plot ScoreProbeLongArrowV0544 =
    if scoreProbeLongSignal and !reviewLongSignal then low - off * 2 else Double.NaN;
plot ScoreProbeShortArrowV0544 =
    if scoreProbeShortSignal and !reviewShortSignal then high + off * 2 else Double.NaN;
ScoreProbeLongArrowV0544.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ScoreProbeShortArrowV0544.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ScoreProbeLongArrowV0544.AssignValueColor(Color.GREEN);
ScoreProbeShortArrowV0544.AssignValueColor(Color.RED);
ScoreProbeLongArrowV0544.SetLineWeight(3);
ScoreProbeShortArrowV0544.SetLineWeight(3);

plot MarkerLongDotV0544 =
    if arrowMarkerLong then low - compactMarkerOff else Double.NaN;
MarkerLongDotV0544.SetPaintingStrategy(PaintingStrategy.POINTS);
MarkerLongDotV0544.SetLineWeight(5);
MarkerLongDotV0544.SetDefaultColor(Color.MAGENTA);

plot MarkerShortDotV0544 =
    if arrowMarkerShort then high + compactMarkerOff else Double.NaN;
MarkerShortDotV0544.SetPaintingStrategy(PaintingStrategy.POINTS);
MarkerShortDotV0544.SetLineWeight(5);
MarkerShortDotV0544.SetDefaultColor(Color.CYAN);
...
plot ReviewTP1LineV0544 =
    if showReviewTargetStopLines and reviewTargetStopActive then reviewTP1Price else Double.NaN;
ReviewTP1LineV0544.SetPaintingStrategy(PaintingStrategy.HORIZONTAL);
ReviewTP1LineV0544.SetStyle(Curve.SHORT_DASH);
ReviewTP1LineV0544.SetLineWeight(2);
ReviewTP1LineV0544.SetDefaultColor(GlobalColor("CautionAmber"));

plot ReviewTP2LineV0544 =
    if showReviewTargetStopLines and reviewTargetStopActive then reviewTP2Price else Double.NaN;
ReviewTP2LineV0544.SetPaintingStrategy(PaintingStrategy.HORIZONTAL);
ReviewTP2LineV0544.SetStyle(Curve.SHORT_DASH);
ReviewTP2LineV0544.SetLineWeight(2);
ReviewTP2LineV0544.SetDefaultColor(GlobalColor("CautionAmber"));

plot ReviewStopLineV0544 =
    if showReviewTargetStopLines and reviewTargetStopActive then reviewStopPrice else Double.NaN;
ReviewStopLineV0544.SetPaintingStrategy(PaintingStrategy.HORIZONTAL);
ReviewStopLineV0544.SetStyle(Curve.SHORT_DASH);
ReviewStopLineV0544.SetLineWeight(2);
ReviewStopLineV0544.SetDefaultColor(Color.RED);
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.44 TEST", Color.CYAN, yes);
...
AddChartBubble(showReviewTargetStopBubbles and visibleLongSignal, reviewTP1Price, "R-TP1", GlobalColor("CautionAmber"), yes);
AddChartBubble(showReviewTargetStopBubbles and visibleLongSignal, reviewTP2Price, "R-TP2", GlobalColor("CautionAmber"), yes);
AddChartBubble(showReviewTargetStopBubbles and visibleLongSignal, reviewStopPrice, "R-SL", Color.RED, no);
AddChartBubble(showReviewTargetStopBubbles and visibleShortSignal, reviewTP1Price, "R-TP1", GlobalColor("CautionAmber"), no);
AddChartBubble(showReviewTargetStopBubbles and visibleShortSignal, reviewTP2Price, "R-TP2", GlobalColor("CautionAmber"), no);
AddChartBubble(showReviewTargetStopBubbles and visibleShortSignal, reviewStopPrice, "R-SL", Color.RED, yes);
AddChartBubble(showReviewTargetStopBubbles and reviewTP1Hit, reviewTP1Price, "R-TP1 HIT", GlobalColor("CautionAmber"), reviewTargetStopDir == 1);
AddChartBubble(showReviewTargetStopBubbles and reviewTP2Hit, reviewTP2Price, "R-TP2 HIT", GlobalColor("CautionAmber"), reviewTargetStopDir == 1);
...
AddLabel(yes, "BUILD: v0.5.44 ARMED DOTS", Color.BLACK);
