...
def rawSetupBubbleLong = rawSetupLongMarker;
def rawSetupBubbleShort = rawSetupShortMarker;
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.17 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.17 RAW BUBBLE", Color.BLACK);
