...
- File: `MacroMicro_Simplified_v0.5.7.ts`
...
- Sustained 5/6 setups can produce `SETUP S/L` caution arrows every `setupPulseBars` bars; v0.5.7 defaults this to 8 bars to reduce clutter.
...
- Confirm the header shows `# Version: v0.5.7` in the pasted source.
