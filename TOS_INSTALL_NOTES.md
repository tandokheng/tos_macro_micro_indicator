...
- File: `MacroMicro_Simplified_v0.5.4.ts`
...
- Sustained 5/6 setups can produce `SETUP S/L` caution arrows at setup start and every `setupPulseBars` bars even when candle confirmation stays strict.
...
- Confirm the header shows `# Version: v0.5.4` in the pasted source.
