...
def realLongEntry = newLongEntry or practicalLongArrow or fastFlipLongArrow;
def realShortEntry = newShortEntry or practicalShortArrow or fastFlipShortArrow;
...
def longSignalCaution = longScore < triggerThreshold or longTradeCaution or fastFlipLongArrow;
def shortSignalCaution = shortScore < triggerThreshold or shortTradeCaution or fastFlipShortArrow;
...
AddChartBubble(
    ...
    low - off * 1.4,
    (if fastFlipLongArrow then "FLIP L " else "ENTRY L ") +
...
AddChartBubble(
    ...
    high + off * 1.4,
    (if fastFlipShortArrow then "FLIP S " else "ENTRY S ") +
