...
# Active build: v0.5.27 REVIEW ONLY.
...
plot ReviewLongArrowV0527 =
    if showReviewSignalArrows and reviewLongSignal then low - off else Double.NaN;
plot ReviewShortArrowV0527 =
    if showReviewSignalArrows and reviewShortSignal then high + off else Double.NaN;
ReviewLongArrowV0527.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ReviewShortArrowV0527.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ReviewLongArrowV0527.AssignValueColor(Color.MAGENTA);
ReviewShortArrowV0527.AssignValueColor(Color.CYAN);
ReviewLongArrowV0527.SetLineWeight(5);
ReviewShortArrowV0527.SetLineWeight(5);

plot ScoreProbeLongArrowV0527 =
    if scoreProbeLongSignal and !reviewLongSignal then low - off * 2 else Double.NaN;
plot ScoreProbeShortArrowV0527 =
    if scoreProbeShortSignal and !reviewShortSignal then high + off * 2 else Double.NaN;
ScoreProbeLongArrowV0527.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ScoreProbeShortArrowV0527.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ScoreProbeLongArrowV0527.AssignValueColor(Color.GREEN);
ScoreProbeShortArrowV0527.AssignValueColor(Color.RED);
ScoreProbeLongArrowV0527.SetLineWeight(3);
ScoreProbeShortArrowV0527.SetLineWeight(3);
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.27 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.27 REVIEW ONLY", Color.BLACK);
