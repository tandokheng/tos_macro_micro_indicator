...
input showTargetStopBubbles = no;
...
# ---------------- Bubbles + Alerts ----------------
AddChartBubble(showSignalBubbles and newLongEntry, low - off * 1.4, "L " + AsText(longScore) + "/6 " + (if longTradeCaution then "CAUTION" else "OK"), Color.GREEN, no);
AddChartBubble(showSignalBubbles and newShortEntry, high + off * 1.4, "S " + AsText(shortScore) + "/6 " + (if shortTradeCaution then "CAUTION" else "OK"), Color.RED, yes);

AddChartBubble(showTargetStopBubbles and targetHit and activeDir[1] == 1, high + off, "PTARGET", Color.YELLOW, yes);
AddChartBubble(showTargetStopBubbles and targetHit and activeDir[1] == -1, low - off, "PTARGET", Color.YELLOW, no);
AddChartBubble(showTargetStopBubbles and stopHit and activeDir[1] == 1, low - off, "SLOSS", Color.RED, no);
AddChartBubble(showTargetStopBubbles and stopHit and activeDir[1] == -1, high + off, "SLOSS", Color.RED, yes);
