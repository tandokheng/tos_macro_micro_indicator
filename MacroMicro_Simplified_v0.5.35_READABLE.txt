...
# Active build: v0.5.35 STRICT MIX.
...
# - DBG SET / DBG REV / DBG BOTH / DBG ESC / DBG MIX / DBG PROBE labels separate setup, review, detected conflict, escaped conflict, blocked conflict, and probe cadence.
...
plot ReviewLongArrowV0535 =
    if showReviewSignalArrows and visibleLongSignal then low - off else Double.NaN;
plot ReviewShortArrowV0535 =
    if showReviewSignalArrows and visibleShortSignal then high + off else Double.NaN;
ReviewLongArrowV0535.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ReviewShortArrowV0535.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ReviewLongArrowV0535.AssignValueColor(Color.MAGENTA);
ReviewShortArrowV0535.AssignValueColor(Color.CYAN);
ReviewLongArrowV0535.SetLineWeight(5);
ReviewShortArrowV0535.SetLineWeight(5);

plot ScoreProbeLongArrowV0535 =
    if scoreProbeLongSignal and !reviewLongSignal then low - off * 2 else Double.NaN;
plot ScoreProbeShortArrowV0535 =
    if scoreProbeShortSignal and !reviewShortSignal then high + off * 2 else Double.NaN;
ScoreProbeLongArrowV0535.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ScoreProbeShortArrowV0535.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ScoreProbeLongArrowV0535.AssignValueColor(Color.GREEN);
ScoreProbeShortArrowV0535.AssignValueColor(Color.RED);
ScoreProbeLongArrowV0535.SetLineWeight(3);
ScoreProbeShortArrowV0535.SetLineWeight(3);
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.35 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.35 STRICT MIX", Color.BLACK);
