...
plot ReviewLongArrowV0525 =
    if showReviewSignalArrows and reviewLongSignal then low - off else Double.NaN;
plot ReviewShortArrowV0525 =
    if showReviewSignalArrows and reviewShortSignal then high + off else Double.NaN;
ReviewLongArrowV0525.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ReviewShortArrowV0525.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ReviewLongArrowV0525.AssignValueColor(Color.MAGENTA);
ReviewShortArrowV0525.AssignValueColor(Color.CYAN);
ReviewLongArrowV0525.SetLineWeight(5);
ReviewShortArrowV0525.SetLineWeight(5);

plot ScoreProbeLongArrowV0525 =
    if scoreProbeLongSignal and !reviewLongSignal then low - off * 2 else Double.NaN;
plot ScoreProbeShortArrowV0525 =
    if scoreProbeShortSignal and !reviewShortSignal then high + off * 2 else Double.NaN;
ScoreProbeLongArrowV0525.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ScoreProbeShortArrowV0525.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ScoreProbeLongArrowV0525.AssignValueColor(Color.GREEN);
ScoreProbeShortArrowV0525.AssignValueColor(Color.RED);
ScoreProbeLongArrowV0525.SetLineWeight(3);
ScoreProbeShortArrowV0525.SetLineWeight(3);
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.25 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.25 NAN SAFE", Color.BLACK);
