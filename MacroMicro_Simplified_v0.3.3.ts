...
def longEntryPulse = rawLongEntry and (longEntryEdge or cooldownJustCleared or longTradeJustUnblocked);
def shortEntryPulse = rawShortEntry and (shortEntryEdge or cooldownJustCleared or shortTradeJustUnblocked);
