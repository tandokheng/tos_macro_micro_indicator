...
- Doing: Review/import `MacroMicro_Simplified_v0.5.13.ts`, a QQQ 5m spam-diagnostic build with always-visible build/raw/contract labels and hardwired raw setup/continuation markers to separate source drift, marker logic, and TOS rendering issues.
