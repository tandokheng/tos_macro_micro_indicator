...
- Doing: Review/import `MacroMicro_Simplified_v0.5.26.ts`, a QQQ 5m clean-visuals build that keeps NaN-safe review/probe arrows while turning large compact `L/S` marker bubbles off by default.
