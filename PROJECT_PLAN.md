...
- Doing: Review/import `MacroMicro_Simplified_v0.5.29.ts`, a QQQ 5m throttled-visual build that keeps NaN-safe review diagnostics intact while reducing repeated plotted arrow clusters.
