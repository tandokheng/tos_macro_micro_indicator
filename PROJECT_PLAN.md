...
- Doing: Review/import `MacroMicro_Simplified_v0.5.30.ts`, a QQQ 5m chop-filter build that keeps clear-direction review arrows while suppressing inefficient sideways setup-review pulses.
