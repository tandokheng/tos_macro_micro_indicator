...
- Doing: Review/import `MacroMicro_Simplified_v0.5.0.ts`, which keeps practical real-entry arrows and changes RVOL into a caution state instead of a hard arrow blocker.
