...
plot VisibleLongArrow = if newLongEntry then low - signalArrowOff else Double.NaN;
...
plot VisibleShortArrow = if newShortEntry then high + signalArrowOff else Double.NaN;
