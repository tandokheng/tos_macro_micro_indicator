...
plot RawSetupLongArrowV0519 =
    if rawSetupBubbleLong then low - off else Double.NaN;
plot RawSetupShortArrowV0519 =
    if rawSetupBubbleShort then high + off else Double.NaN;
RawSetupLongArrowV0519.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
RawSetupShortArrowV0519.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
RawSetupLongArrowV0519.AssignValueColor(Color.MAGENTA);
RawSetupShortArrowV0519.AssignValueColor(Color.CYAN);
RawSetupLongArrowV0519.SetLineWeight(5);
RawSetupShortArrowV0519.SetLineWeight(5);
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.19 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.19 RAW ARROWS", Color.BLACK);
