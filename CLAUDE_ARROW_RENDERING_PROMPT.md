...
- Use v0.5.25's NaN-safe review build as the starting point: real entries plus setup-edge/quality-upgrade review arrows, a slow quality-gated sustained setup refresh, and visual-only score-probe diagnostics, not repeated raw cadence.
