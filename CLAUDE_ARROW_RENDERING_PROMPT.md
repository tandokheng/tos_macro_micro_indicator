...
- Use v0.5.26's clean-visuals build as the starting point: NaN-safe review/probe arrows remain active, but compact `L/S` marker bubbles are optional through `showSignalBubbles`.
