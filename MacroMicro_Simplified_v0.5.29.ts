...
# Active build: v0.5.29 THROTTLED VIS.
...
plot ReviewLongArrowV0529 =
    if showReviewSignalArrows and visibleLongSignal then low - off else Double.NaN;
plot ReviewShortArrowV0529 =
    if showReviewSignalArrows and visibleShortSignal then high + off else Double.NaN;
ReviewLongArrowV0529.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ReviewShortArrowV0529.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ReviewLongArrowV0529.AssignValueColor(Color.MAGENTA);
ReviewShortArrowV0529.AssignValueColor(Color.CYAN);
ReviewLongArrowV0529.SetLineWeight(5);
ReviewShortArrowV0529.SetLineWeight(5);

plot ScoreProbeLongArrowV0529 =
    if scoreProbeLongSignal and !reviewLongSignal then low - off * 2 else Double.NaN;
plot ScoreProbeShortArrowV0529 =
    if scoreProbeShortSignal and !reviewShortSignal then high + off * 2 else Double.NaN;
ScoreProbeLongArrowV0529.SetPaintingStrategy(PaintingStrategy.ARROW_UP);
ScoreProbeShortArrowV0529.SetPaintingStrategy(PaintingStrategy.ARROW_DOWN);
ScoreProbeLongArrowV0529.AssignValueColor(Color.GREEN);
ScoreProbeShortArrowV0529.AssignValueColor(Color.RED);
ScoreProbeLongArrowV0529.SetLineWeight(3);
ScoreProbeShortArrowV0529.SetLineWeight(3);
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.29 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.29 THROTTLED VIS", Color.BLACK);
