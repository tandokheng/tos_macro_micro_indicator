...
def longScoreCrossTrigger = longScore >= triggerThreshold and longScore[1] < triggerThreshold and longCandleConfirm;
def shortScoreCrossTrigger = shortScore >= triggerThreshold and shortScore[1] < triggerThreshold and shortCandleConfirm;

def longTrigger = longScoreCrossTrigger or (microCrossUp and longCandleConfirm) or momentumLong or trendRejectionLong;
def shortTrigger = shortScoreCrossTrigger or (microCrossDown and shortCandleConfirm) or momentumShort or trendRejectionShort;
