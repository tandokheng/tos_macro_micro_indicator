...
def visualLongSetupReady = setupPulseLongArrow;
def visualShortSetupReady = setupPulseShortArrow;
...
AddChartBubble(lastVisibleBar, high + liveArrowOff * 1.3, "v0.5.15 TEST", Color.CYAN, yes);
...
AddLabel(yes, "BUILD: v0.5.15 CLEAN RAW", Color.BLACK);
